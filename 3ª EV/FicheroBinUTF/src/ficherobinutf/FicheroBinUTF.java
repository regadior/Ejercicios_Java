...
public class FicheroBinUTF{
	...
	static int menu(Scanner e) {
		...
		System.out.println("3.Crear fichero seg�n inicial.");
		System.out.println("4.Listar fichero seg�n inicial.");
		...
		try {
			...
			while(!fin) {
				try {
					...
					entrada.close(); // da igual cerrarlos aqu� o donde est� comentado porque la excepci�n lo que controla es el fin del fichero.
					salida.close();
					fin=true;
				}			
			}		
