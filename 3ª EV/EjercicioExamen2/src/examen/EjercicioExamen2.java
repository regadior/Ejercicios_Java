...
public class EjercicioExamen2{
	...
	static int menu(Scanner e) {
		...
		do {
			try {
				...
				System.out.println("Teclee opci�n (1-4)");
				op=e.nextInt();
	...
	static void altas(Scanner e) {
		...
		try {
			...
			do {
				System.out.println("Teclee c�digo (* para terminar)");
				codigo=e.nextLine();
			}while(codigo.length()!=6);
			while(!codigo.equals("*")){
				do {
					System.out.println("Teclee denominaci�n");
			...
			System.out.println("La ruta indicada no es v�lida.");
		}
	}
	static void factura() {
		...
		try {
			...
			System.out.println("C�digo\tDenominaci�n\tPrec. Uni\tTipo\tPrecio\tIVA\tPrecio+IVA");
			codigo=lee.readLine();
	...
	static void modificarFactura(Scanner e) {
		...
		do {
			System.out.println("�C�digo del art�culo a modificar?");
			codigoBus=e.nextLine();		
			ia=buscarArticulo(codigoBus, ar);
			if(ia==ar.length)
				System.out.println("El art�culo /"+codigoBus+"\" no existe.");
			else {
				System.out.println("C�digo............"+ar[ia].getCodigo()+"\nDenominacion............"+
